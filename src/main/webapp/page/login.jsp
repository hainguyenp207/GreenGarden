...
<div class='preload login--container'>
    ...
    <div class='login--form'>
        <div class='login--username-container'>
            ...
            <input autofocus placeholder='Tên đăng nhập' name="username" type='text'>
        </div>
        <div class='login--password-container'>
            <label>Mật khẩu</label>
            <input placeholder='Nhập mật khẩu của bạn' name="password" type='password'>
            <button type="submit" class='js-toggle-login login--login-submit'>Đăng nhập</button>
        </div>
    </div>
