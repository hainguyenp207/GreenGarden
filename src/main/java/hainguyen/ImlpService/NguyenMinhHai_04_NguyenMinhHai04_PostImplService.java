...
@Service("PostService")
@Transactional
public class NguyenMinhHai_04_NguyenMinhHai04_PostImplService implements NguyenMinhHai_04_PostService {
    @Autowired
    NguyenMinhHai_04_PostNguyenMinhHai04Crud nguyenMinhHai04PostCrud;
    @Override
